...
public class JingPin_Holder extends BaseHolder<HomeGameListBean.MsgEntity> {
    ...
    protected void refreshView(HomeGameListBean.MsgEntity msgEntity, int position, Activity activity) {
        ...
        Glide.with(x.app()).load(msgEntity.getIcon()).error(R.drawable.default_picture).into(game_icon);
        Glide.with(x.app()).load(msgEntity.getCover()).error(R.drawable.default_picture).into(Tu);
    ...
    protected View initView() {
        ...
        game_icon = (ImageView)inflate.findViewById(R.id.game_icon);
        kaishi = (TextView)inflate.findViewById(R.id.kaishi);
        name = (TextView)inflate.findViewById(R.id.name);
        ren = (TextView)inflate.findViewById(R.id.ren);
        Tu = (ImageView) inflate.findViewById(R.id.icon);
        inflate.setTag(this);
        return inflate;
    }
