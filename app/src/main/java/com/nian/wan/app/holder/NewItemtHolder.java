 ...
 * 描述：新上架
 */
public class NewItemtHolder extends RecyclerView.ViewHolder {
...
//    CheckBox cbDelete;
    ...
    private final boolean isH5Game;
    ...
    public NewItemtHolder(View itemView, Activity act, boolean isH5Game) {
        super(itemView);
