...
public class BottomTabView extends LinearLayout {
    ...
    public BottomTabView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {super(context, attrs, defStyleAttr); }
    ...
    public List<TabItemView> getTabItemView() {
...
//            throw new RuntimeException("不能重复设置！");
    ...
    public static class TabItemView extends LinearLayout {
        ...
        public TabItemView(Context context, String title, int colorDef, int colorPress,int iconResDef, int iconResPress, boolean isShowRedPoint) {
            super(context);
            this.title = title;
         ...
         */
        public void init() {
            View view = LayoutInflater.from(super.getContext()).inflate(R.layout.bottom_navagation_item, this);
            tvTitle = (TextView) view.findViewById(R.id.tvTitle);
            ivIcon = (ImageView) view.findViewById(R.id.ivIcon);
            tvRedPoint = (TextView) view.findViewById(R.id.iv_tab_red_point);
            tvRedPoint.setVisibility(isShowRedPoint == true ? VISIBLE : INVISIBLE);
