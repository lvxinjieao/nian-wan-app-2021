 ...
 * @Description:
 * @Author: XiaYuShi
 * @Date: Created in 我的收藏确认删除
 * @Modified By:
 * @Modified Date:
 */
public class DialogMyCollectionConfirmDelete extends Dialog {
    ...
    public DialogMyCollectionConfirmDelete(Context context, int themeResId, Handler handler) {
        super(context, themeResId);
        this.mContext = context;
        this.mIsAddressExcitHandler = handler;
        inflate = LinearLayout.inflate(context, R.layout.dialog_my_collection_confirm_delete, null);
    }
