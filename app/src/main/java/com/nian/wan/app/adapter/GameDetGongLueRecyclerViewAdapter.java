 ...
 * @Date: 2017/11/15
 * @Description:
 * @Modify By: 游戏详情攻略活动RecyclerView适配器
 * @ModifyDate:
 */

public class GameDetGongLueRecyclerViewAdapter extends
        RecyclerView.Adapter<GameDetGongLueRecyclerViewAdapter.ViewHolder> {


    private List<HomeGameActivitiesBean> list;
    private WeakReference<Context> mWeakReference;

    public GameDetGongLueRecyclerViewAdapter(List<HomeGameActivitiesBean> activitiesBeanList, Context context) {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        holder.tvHomeGameActivitieName.setText(list.get(position).getTitle());
        holder.tvHomeGameActivitiesDescription.setText(list.get(position).getDescription());
