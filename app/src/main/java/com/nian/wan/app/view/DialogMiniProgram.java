 ...
 * 时间: 2018-05-23 11:10
 */
public class DialogMiniProgram extends Dialog {
    @BindView(R.id.img_RQ_Code)
    ImageView imgRQCode;
    @BindView(R.id.btn_save_code)
    LinearLayout btnSaveCode;
    ...
    public DialogMiniProgram(@NonNull Activity mActivity, int themeResId, String imgURL) {
        super(mActivity, themeResId);
        this.codeURL = imgURL;
        this.activity = mActivity;
        view = LinearLayout.inflate(mActivity, R.layout.dialog_mini_program, null);
    }
