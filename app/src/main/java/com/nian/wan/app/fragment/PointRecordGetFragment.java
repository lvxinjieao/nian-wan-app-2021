...
public class PointRecordGetFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        adapter = new PointRecordListAdapter(getActivity(), 1);
    ...
    Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 1:
                    try {
                        Log.e("PointRecordAllFragment", "积分获取记录返回数据：" + msg.obj.toString());
